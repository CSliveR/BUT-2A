...
class Categorie {
  ...
  public function readSubCategorie(): array { 
    ...
    // Récupère le résultat qui correspond à l'ensemble des pères d'une catégorie soit toutes les sous-catégories
    $enfants = $query->fetchAll();

    foreach($enfants as $enfant){
      $subCategory[] = new Categorie($enfant['id'], $enfant['nom'], $enfant['pere']);
    }
