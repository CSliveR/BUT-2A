...
import fr.iut2.todolist.db.DatabaseClient;
import fr.iut2.todolist.db.Task;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listTask.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Message
                Toast.makeText(MainActivity.this, "Click : " + task.getLibelle(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        listTask.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // Message
                Toast.makeText(MainActivity.this, "LongClick : " + task.getLibelle(), Toast.LENGTH_SHORT).show();
